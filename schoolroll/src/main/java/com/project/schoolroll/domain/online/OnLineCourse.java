...
@DynamicUpdate
@DynamicInsert
@org.hibernate.annotations.Table(appliesTo = "on_line_course", comment = "科目")
@Table(name = "on_line_course", indexes = {@Index(columnList = "course_id", name = "course_id_index")})
@EqualsAndHashCode(callSuper = true)
public class OnLineCourse extends Entitys {
