...
@Table(name = "train_class", indexes = {@Index(columnList = "train_class_id", name = "train_class_id_index")})
...
public class TrainClass extends Entitys implements Serializable {
    ...
    @Column(name = "pj_plan_name", columnDefinition = "VARCHAR(100) COMMENT '培训项目计划名称'")
